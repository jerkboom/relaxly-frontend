...
import { FaTimesCircle, FaSignOutAlt, FaEnvelopeOpenText } from 'react-icons/fa';
...
export default function RejectedPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
      <div className="w-full max-w-[600px] rounded-[2.5rem] bg-white p-8 sm:p-12 shadow-xl text-center border-t-8 border-red-500">
        <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-3xl bg-red-50 text-5xl text-red-500">
          <FaTimesCircle />
        </div>
        ...
        <p className="text-slate-500 mb-10 leading-relaxed text-lg">
          If you believe this was a mistake or you have updated documents, please contact our support team.
        </p>
